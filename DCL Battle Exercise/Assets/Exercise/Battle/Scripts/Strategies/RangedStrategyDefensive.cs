...
public class RangedStrategyDefensive : UnitStrategy
{
    public RangedStrategyDefensive(UnitBase unit) : base(unit) { }
    ...
    public override void Update()
    {
        ...
        bool enemyFound = unit.EnemyArmy.GetClosestUnit(position, out float distToNearest, out UnitBase nearestEnemy);
